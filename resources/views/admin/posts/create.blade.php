...
@section('title', $title = "افزودن پست")
            ...
            <form role="form" action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name" id="name" placeholder="نام پست" value="{{ old('name') }}">
                    </div>
                    <div class="form-group">
                        <label for="slug">نامک</label>
                        <input type="text" class="form-control" name="slug" id="slug" placeholder="نامک پست" value="{{ old('slug') }}">
                    </div>
                    <div class="form-group">
